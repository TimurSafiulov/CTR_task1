...
**Предметна область:** Системи електромобіля (EV).
...
## 2. Структурний шаблон: Adapter (Адаптер)
...
## 3. Поведінковий шаблон: Observer (Спостерігач)
...
battery.set_voltage(12.0) # Все ок
battery.set_voltage(11.0) # Спрацює сповіщення
```
